...
public class ParallelStream {
    public static void main(String[] args) {
        ...
        MyUtility.print("Time taken with sequential stream: " + (endTime - startTime) + " ms");
...
//        factorialsList = list.parallelStream().map(ParallelStream::factorial).sequential().toList();
        ...
        MyUtility.print("Time taken with parallel stream: " + (endTime - startTime) + " ms");
        ...
        MyUtility.print("Expected cumulative sum: [1, 3, 6, 10, 15]");
        MyUtility.print("Actual result with parallel stream: " + cumulativeSum);
